function group_psth_normrange_by_option_CI_alignable(C, sessionIdxs, neuronIdxs, align_event_name, bin_ms, smooth_ms, win, baseline_win, error_type, ci_alpha, baseline_event_name)
...
%   group_psth_normrange_by_option_CI_alignable(C, sessions, neurons, 'm1rew2on', 20, 100);
%   group_psth_normrange_by_option_CI_alignable(C, sessions, neurons, 'offerOn', 20, 100, [-800 1200]);
%   % If your baseline event has a different name:
%   group_psth_normrange_by_option_CI_alignable(C, sessions, neurons, 'm1rew2on', 20, 100, [], [], 'ci', 0.95, 'm1rew1on');
