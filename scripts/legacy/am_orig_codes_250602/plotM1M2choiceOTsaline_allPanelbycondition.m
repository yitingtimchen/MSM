...
subplot(4,2,1);
bl1 = boundedline(time, m1rew1onMean_aiS, SEM_m1rew1on_aiS, ...
    time, m2rew1onMean_aiS, SEM_m2rew1on_aiS, ...
...
subplot(4,2,2);
bl1 = boundedline(time, m1rew1onMean_aiOT, SEM_m1rew1on_aiOT, ...
    time, m2rew1onMean_aiOT, SEM_m2rew1on_aiOT, ...
    'cmap', colors,'transparency',0.5);
hold on
set(gca,'FontSize',16);
% Add lines
...
subplot(4,2,3);
bl2 = boundedline(time, m1rew1onMean_replayS, SEM_m1rew1on_replayS, ...
...
subplot(4,2,4);
bl2 = boundedline(time, m1rew1onMean_replayOT, SEM_m1rew1on_replayOT, ...
...
subplot(4,2,5);
bl3 = boundedline(time, m1rew1onMean_decoyS, SEM_m1rew1on_decoyS, ...
...
subplot(4,2,6);
bl3 = boundedline(time, m1rew1onMean_decoyOT, SEM_m1rew1on_decoyOT, ...
...
subplot(4,2,7);
bl4 = boundedline(time, m1rew1onMean_liveS, SEM_m1rew1on_liveS, ...
...
subplot(4,2,8);
bl4 = boundedline(time, m1rew1onMean_liveOT, SEM_m1rew1on_liveOT, ...
...
lh = legend(bl1);
legnames = {'m1rew1on','Non-m1rew1on'};
...
print('-fillpage','OTsalineM1M2rew1onPanelbyCondition','-dpdf');
