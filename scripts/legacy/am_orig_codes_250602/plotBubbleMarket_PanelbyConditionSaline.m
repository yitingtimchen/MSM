...
data(:,:,1) = bubbleUnits_ai(:,1:108);
data(:,:,2) = nonbubbleUnits_ai(:,1:108);
data(:,:,3) = bubbleUnits_replay(:,1:108);
data(:,:,4) = nonbubbleUnits_replay(:,1:108);
data(:,:,5) = bubbleUnits_decoy(:,1:108);
data(:,:,6) = nonbubbleUnits_decoy(:,1:108);
data(:,:,7) = bubbleUnits_live(:,1:108);
data(:,:,8) = nonbubbleUnits_live(:,1:108);
