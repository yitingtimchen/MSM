...
n = n-1;
    ...
    buyUnits_liveOT = [buyUnits_liveOT(:,32:93) buyUnits_liveOT(:,103:end)];
    holdUnits_liveOT = [holdUnits_liveOT(:,32:93) holdUnits_liveOT(:,103:end)];
    sellUnits_liveOT = [sellUnits_liveOT(:,32:93) sellUnits_liveOT(:,103:end)];
...
print('OTsalinechoicePanelbyConditionV2','-dpdf');
