% File: d20251118_extract_spike_event_condition_packs.m
% =========================================================================
...
spreadsheet_path = 'C:\Users\plattlab\MSM\data\metadata\MSM_neuronSortMASTER_recoveryFile.xlsx';
behavior_path    = 'C:\Users\plattlab\MSM\data\tooling\MATLAB_Copy\dataTabFULL.xlsx';
root_path        = 'C:\Users\plattlab\MSM\data\neural\raw_external\MSM_Sorted\nex\';
OUTDIR = fullfile('C:\Users\plattlab\MSM', 'outputs_local', 'condition_packs_251118');
...
for c = 1:numel(allConds)
    ...
    for f = 1:numel(fileList)
        ...
        % Read .nex content
        F = d20260213_read_nex_file(nexPath);
