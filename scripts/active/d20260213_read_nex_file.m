% File: d20260213_read_nex_file.m
function [nexFile] = d20260213_read_nex_file(fileName)
% [nexFile] = d20260213_read_nex_file(fileName) -- read .nex file and return file data
