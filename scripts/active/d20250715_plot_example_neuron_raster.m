% File: d20250715_plot_example_neuron_raster.m
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
% Dependencies:
%   - Requires NexTools or similar implementation for d20260213_read_nex_file()
%
% Author: Tim Chen
% Lab: Platt Lab
% Date: 7/16/2025
...
%% Load Data
file = d20260213_read_nex_file(root_path + file_name);
