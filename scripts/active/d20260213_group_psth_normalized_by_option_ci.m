% File: d20260213_group_psth_normalized_by_option_ci.m
function d20260213_group_psth_normalized_by_option_ci(C, sessionIdxs, neuronIdxs, bin_ms, smooth_ms, win, baseline_win, error_type, ci_alpha)
...
%   d20260213_group_psth_normalized_by_option_ci(C, sessions, neurons, 20, 100);                 % 95% CI (default)
%   d20260213_group_psth_normalized_by_option_ci(C, sessions, neurons, 20, 100, [], [], 'sem');  % SEM shading
%   d20260213_group_psth_normalized_by_option_ci(C, sessions, neurons, 20, 100, [], [], 'ci', 0.90); % 90% CI
