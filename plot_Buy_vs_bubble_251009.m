...
% ------------------- Load -------------------
try
T = readtable('C:\Users\plattlab\Tim\Stock_market_experiment\MATLAB_Copy\dataTabFULL.xlsx','Sheet','Sheet1');
% % if we want sessions included in the behavior-only analysis
% T = readtable('C:\Users\plattlab\Tim\Stock_market_experiment\Tim\condition_packs_behavior_only_v2\dataTabFULL_filtered_from_recoveryFile.xlsx','Sheet','Sheet1');
catch
