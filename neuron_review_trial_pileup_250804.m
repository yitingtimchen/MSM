...
sheet = "C:\Users\plattlab\Tim\Stock_market_experiment\MATLAB_Copy\dataTabFULL.xlsx";
...
if exist(cacheFile, 'file')
    ...
    for i = 1:numel(rawFiles)
        ...
        data  = readNexFile(fullfile(rootPath,fname));
...
updatePlot();
    ...
    function enumUpdate()
        data = readNexFile(fullfile(rootPath,fileList{fileIdx}));
