...
cd('C:\Users\plattlab\Tim\Stock_market_experiment\Tim\condition_packs_250922')
...
group_psth_normrange_by_option_CI_alignable(C, sessions, neurons, 'm1rew1on',  20, 100, [-1500 1500], [-1000 -700], 'ci', 0.90, 'm1rew1on');
group_psth_normrange_by_option_CI(C, sessions, neurons, 20, 100, [-1500 1500], [-1000 -700], 'ci', 0.90);
